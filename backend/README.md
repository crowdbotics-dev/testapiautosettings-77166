...
## Project Structure
    ...
    ├── testapiautosettings_77166  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_77166`
...
2. Clone this repo and `cd testapiautosettings_77166`
